...
export const ProductItem = ({ game, handleOnClick, isInCart, isLoading }: ProductItemProps) => {
  return (
      ...
      <div className="flex flex-col flex-grow justify-between">
        <div>
          ...
          <div className="flex justify-between items-center mt-3">
            <h3 className="text-secondary text-lg font-bold truncate max-w-[240px]" title={game.name}>
              {game.name}
            </h3>
